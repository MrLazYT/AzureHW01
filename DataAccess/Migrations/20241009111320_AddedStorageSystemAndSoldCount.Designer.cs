...
namespace AutoShop.Migrations
{
    ...
    [Migration("20241009111320_AddedStorageSystemAndSoldCount")]
    partial class AddedStorageSystemAndSoldCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Entities.StorageItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccess.Entities.StorageItem", b =>
                {
                    b.HasOne("DataAccess.Entities.Car", "Car")
                        .WithOne("StorageItem")
                        .HasForeignKey("DataAccess.Entities.StorageItem", "CarId")
                        .HasPrincipalKey("DataAccess.Entities.Car", "StorageItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
